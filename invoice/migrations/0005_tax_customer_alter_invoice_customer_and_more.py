...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('invoice', '0004_alter_payment_options_alter_soldproduct_options'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='payment',
            name='customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoice_customer', to='invoice.customer'),
        ),
        migrations.AlterField(
